    ...
    render(){
        ...
        return (<div className="controller erase_controller">
            ...
            <div style={{width:'90%', height: '100%', display: 'inline-block', overflow:'hidden', position:'relative'}}>
                ...
                style={{width: this.props.mother_state.erase_size/pixellength*this.props.mother_state.boardlength*this.props.mother_state.boardzoom, 
                height: this.props.mother_state.erase_size/pixellength*this.props.mother_state.boardlength*this.props.mother_state.boardzoom,
                position:'absolute', left: 165.6/2-this.props.mother_state.erase_size/pixellength*this.props.mother_state.boardlength*this.props.mother_state.boardzoom/2,
                top: 184/2-this.props.mother_state.erase_size/pixellength*this.props.mother_state.boardlength*this.props.mother_state.boardzoom/2,
